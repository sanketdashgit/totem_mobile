...
class RecaptchaV2 extends StatefulWidget {
  ...
  RecaptchaV2({
    ...
    this.textCancelButtom: LabelStr.lblCancelCaptcha,
    ...
    this.onVerifiedError,
        ...
        assert(apiKey != null, Messages.CReCaptchaKeyMissing),
        assert(apiSecret != null, Messages.CReCaptchaSecretMissing);
...
class _RecaptchaV2State extends State<RecaptchaV2> {
  ...
  void verifyToken(String token) async {
    ...
    http.Response response = await http.post(Uri.parse(url), body: {
      Parameters.CSecret: widget.apiSecret,
      Parameters.CResponse: token,
    });
