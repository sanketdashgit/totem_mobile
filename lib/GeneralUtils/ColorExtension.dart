...
class HexColor extends Color {
  ...
  static HexColor hintColor = HexColor('#8086A3');
  static HexColor iconColor=HexColor('#0A0525');
  static HexColor borderColor=HexColor('#3C456C');
  static HexColor   textColor=HexColor('#B0ACC3');
  static HexColor loginColor=HexColor('#3EC0C5');
